...
export function buildRankResultsPrompt(
  ...
  const systemPrompt = [
    ...
    "## `why` field",
    "",
    "≤ 120 chars plain-English reason quoting CONCRETE signal from the profile.",
    "Cite the field you used: feature value, theme insight, pros/cons quote, or",
    "a phrase from the summary.",
    "",
    "Good examples:",
